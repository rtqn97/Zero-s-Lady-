...
function startMusic() {
  ...
  iframe.width = "0";
  iframe.height = "0";
  iframe.src = `https://www.youtube.com/embed/${randomSong}?autoplay=1&loop=1&playlist=${randomSong}&mute=0`;
...
function showSection(index) {
  ...
  // Typewriter for section
  typeText(sections[index].text, textEl, () => {
    nextBtn.classList.remove("hidden");

    // Music button only for first section if music hasn't started
